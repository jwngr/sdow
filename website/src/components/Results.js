...
const Results = props => {
  ...
  const renderSnarkyContentHandler = useCallback(degreesOfSeparation => {
    let snarkyContent;
  ...
  const renderRedirectWarningHandler = useCallback((isSourceRedirected, isTargetRedirected) => {
    let redirectContent;
  ...
  return (
    <React.Fragment>
      <ResultsMessage>
        {renderSnarkyContentHandler(degreesOfSeparation)}
        <p>
          Found{' '}
          <b>
        ...
        {renderRedirectWarningHandler(isSourceRedirected, isTargetRedirected)}
      </ResultsMessage>
      <TwitterButtonWrapper
